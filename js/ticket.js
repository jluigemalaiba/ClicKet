(() => {
  ...
  const isDetailedBowl = ['cuneta', 'moa-sports', 'moa-concert', 'philippine-concert', 'araneta-concert', 'araneta-sports', 'philsports-svg', 'tanghalan-svg'].includes(config.venue.mapKey);
