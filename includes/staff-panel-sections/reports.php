...
$scannedTickets = (int) floor($metrics['tickets'] * .42);
$attendanceRate = $metrics['tickets'] > 0 ? (int) round(($scannedTickets / $metrics['tickets']) * 100) : 0;
